            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i789 in range(_size785):
                        _key790 = iprot.readI32()
                        _val791 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success[_key790] = _val791
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getPreferredDisplayName_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i798 in range(_size794):
                        _elem799 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem799)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.mids is not None:
            ...
            for iter800 in self.mids:
                oprot.writeString(iter800.encode('utf-8') if sys.version_info[0] == 2 else iter800)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getPreferredDisplayName_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i805 in range(_size801):
                        _key806 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val807 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success[_key806] = _val807
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter808, viter809 in self.success.items():
...
class getContactsForChannel_args(object):
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i814 in range(_size810):
                        _elem815 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem815)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ids is not None:
            ...
            for iter816 in self.ids:
                oprot.writeString(iter816.encode('utf-8') if sys.version_info[0] == 2 else iter816)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class createRoomWithBuddy_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i856 in range(_size852):
                        ...
                        self.contactIds.append(_elem857)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.contactIds is not None:
            ...
            for iter858 in self.contactIds:
...
class inviteIntoGroupCall_args(object):
            ...
            if fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i870 in range(_size866):
                        ...
                        self.memberMids.append(_elem871)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.memberMids is not None:
            ...
            for iter872 in self.memberMids:
...
class getGroupsForChannel_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i884 in range(_size880):
                        _elem885 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.groupIds.append(_elem885)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.groupIds is not None:
            ...
            for iter886 in self.groupIds:
                oprot.writeString(iter886.encode('utf-8') if sys.version_info[0] == 2 else iter886)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i898 in range(_size894):
                        _elem899 = PaidCallCurrencyExchangeRate()
                        _elem899.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i905 in range(_size901):
                        _elem906 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class getPersonalInfos_args(object):
            ...
            if fid == 1:
                if ftype == TType.SET:
                    ...
                    for _i919 in range(_size915):
                        ...
                        self.requiredPersonalInfos.add(_elem920)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.requiredPersonalInfos is not None:
            ...
            for iter921 in self.requiredPersonalInfos:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i926 in range(_size922):
                        _key927 = iprot.readI32()
                        _val928 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter929, viter930 in self.success.items():
                oprot.writeI32(kiter929)
                oprot.writeString(viter930.encode('utf-8') if sys.version_info[0] == 2 else viter930)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getPrimaryClientsForChannel_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i935 in range(_size931):
                        _elem936 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.userMids.append(_elem936)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.userMids is not None:
            ...
            for iter937 in self.userMids:
                oprot.writeString(iter937.encode('utf-8') if sys.version_info[0] == 2 else iter937)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i949 in range(_size945):
                        _elem950 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i956 in range(_size952):
                        _elem957 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem957)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class getReverseCompactContacts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i963 in range(_size959):
                        ...
                        _val965 = CompactContact()
                        _val965.read(iprot)
                        self.success[_key964] = _val965
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter966, viter967 in self.success.items():
                oprot.writeString(kiter966.encode('utf-8') if sys.version_info[0] == 2 else kiter966)
                viter967.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class displayBuddySubscriberCountInBulk_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i979 in range(_size975):
                        _elem980 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem980)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.mids is not None:
            oprot.writeFieldBegin('mids', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.mids))
            for iter981 in self.mids:
                oprot.writeString(iter981.encode('utf-8') if sys.version_info[0] == 2 else iter981)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class displayBuddySubscriberCountInBulk_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i986 in range(_size982):
                        _key987 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val988 = iprot.readI64()
                        self.success[_key987] = _val988
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter989, viter990 in self.success.items():
                oprot.writeString(kiter989.encode('utf-8') if sys.version_info[0] == 2 else kiter989)
                oprot.writeI64(viter990)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1002 in range(_size998):
                        _elem1003 = SimpleChannelContact()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1009 in range(_size1005):
                        _elem1010 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1023 in range(_size1019):
                        ...
                        self.userMids.append(_elem1024)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1072 in range(_size1068):
                        _elem1073 = SimpleChannelContact()
