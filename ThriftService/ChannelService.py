            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1088 in range(_size1084):
                        _elem1089 = ChannelNotificationSetting()
                        _elem1089.read(iprot)
                        self.success.append(_elem1089)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1095 in range(_size1091):
                        _elem1096 = ChannelNotificationSetting()
                        _elem1096.read(iprot)
                        self.setting.append(_elem1096)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class issueRequestTokenWithAuthScheme_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1102 in range(_size1098):
                        _elem1103 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.authScheme.append(_elem1103)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.authScheme is not None:
            ...
            for iter1104 in self.authScheme:
                oprot.writeString(iter1104.encode('utf-8') if sys.version_info[0] == 2 else iter1104)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class getFriendChannelMatrices_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1109 in range(_size1105):
                        _elem1110 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.channelIds.append(_elem1110)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1111 in self.channelIds:
                oprot.writeString(iter1111.encode('utf-8') if sys.version_info[0] == 2 else iter1111)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getUpdatedChannelIds_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1116 in range(_size1112):
                        _elem1117 = ChannelIdWithLastUpdated()
                        _elem1117.read(iprot)
                        self.channelIds.append(_elem1117)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1118 in self.channelIds:
